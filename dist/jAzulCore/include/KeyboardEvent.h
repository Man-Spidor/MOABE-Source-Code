...
/// Enumerates the different key codes.
...
public:
    /// @enum EventType
    /// Enumerates the different types of keyboard events.
...
public:
    ...
    /// Parameterized constructor to initialize the keyboard event with specific values.
